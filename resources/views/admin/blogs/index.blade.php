                                        ...
                                        <table class="datatable table table-stripped dataTable no-footer"
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                   ...
                                                   <td><span class="badge badge-sm {{$blog->status=='active'?'badge-success': 'badge-danger' }}">{{strpos($blog->status, '_') !== false ? ucwords(str_replace('_', ' ', $blog->status)) : ucwords($blog->status)}}</span></td>
                                                   ...
                                                   <div class="dropdown-menu">
                                                       ...
                                                       <a class="dropdown-item" onclick="deleteBlog({{$blog->id}})">Delete</a>
                                                   </div>
                                               </td>
                                               </tr>
                                                @endforeach
