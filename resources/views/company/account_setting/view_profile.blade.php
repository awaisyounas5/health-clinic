    ...
    <div class="content">
        <div class="page-header">
            <div class="row">
                <div class="col-sm-12">
                    <ul class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{route('company.view.profile')}}">Profile </a></li>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-4 col-md-4 d-flex align-items-center">
                                            <div class="follow-btn-group">
                                                <a href="{{route('company.edit.profile')}}" class="btn btn-info follow-btns">Edit Profile</a>
