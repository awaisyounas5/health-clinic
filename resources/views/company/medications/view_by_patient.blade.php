    ...
    <div class="content">
        <div class="page-header">
            <div class="row">
                <div class="col-sm-12">
                    <ul class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{ route('company.medications') }}">Medications List</a></li>
                                    ...
                                    <tr id="row{{$medication->id}}">
                                        ...
                                        <td>
                                            ...
                                            <div class="dropdown-menu">
                                                <a class="dropdown-item" href="{{ route('company.medications.edit', $medication->id) }}">Edit</a>
    ...
    function medicationDelete($id) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                $.ajax({
                    type: 'DELETE',
                    url: '/company/medications/delete/' + $id,
                    data: {
