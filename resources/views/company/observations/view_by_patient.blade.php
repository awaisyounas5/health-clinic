    ...
    <div class="content">
        <div class="page-header">
            <div class="row">
                <div class="col-sm-12">
                    <ul class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{route('company.observation')}}">Observation List </a></li>
                                            ...
                                            <tbody>
                                                ...
                                                <tr role="row" class="odd" id="row{{$observation->id}}">
                                                    ...
                                                    <div class="dropdown-menu">
                                                        <a class="dropdown-item" href="{{route('company.observation.edit',$observation->id)}}">Edit</a>
        ...
        function deleteObservation($id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        type: 'DELETE',
                        url: '/company/observation/delete/' + $id,
                        data: {
