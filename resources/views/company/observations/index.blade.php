    ...
    <div class="content">
        <div class="page-header">
            <div class="row">
                <div class="col-sm-12">
                    <ul class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{route('company.observation')}}">Observations </a></li>
                                        ...
                                        <table class="datatable table table-stripped dataTable no-footer"
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a class="btn btn-primary" href="{{ route('company.observation.view', $patientId) }}">View Entire Observations List</a>
                                                    </td>
                                                </tr>
                                                @endforeach
                                            </tbody>
