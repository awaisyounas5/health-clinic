                                            ...
                                            <tbody>
                                                ...
                                                <tr role="row" class="odd" id="row{{$staff->id}}">
                                                    ...
                                                    <div class="dropdown-menu">
                                                        <a class="dropdown-item" href="{{route('company.staff.view',$staff->id)}}">View</a>
                                                        <a class="dropdown-item" href="{{route('company.staff.edit',$staff->id)}}">Edit</a>
