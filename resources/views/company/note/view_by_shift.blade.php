    ...
    <div class="content">
        <div class="page-header">
            <div class="row">
                <div class="col-sm-12">
                    <ul class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{ route('company.incidents.view_reports') }}">Shift Notes </a></li>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="dropdown">
                                                            ...
                                                            <li><a class="dropdown-item" href="{{ route('company.shift_note.view_details', $shift->id) }}">View</a></li>
                                                            </ul>
                                                        </div>
                                                    </td>
                                                </tr>
