...
@section('content')
                ...
                <div class="col-sm-12">
                    <div class="card-box">
                        <div class="card-block">
                            <h6 class="card-title text-bold">Create Risk Assessment</h6>
                            <form action="{{ route('company.risk_assessment.store') }}" method="POST"
                                ...
                                <div class="form-group mb-4">
                                    ...
                                    <input type="text" name="activity_issue" id="activity_issue" class="form-control"
                                        required placeholder="Enter activity or issue being assessed">
                                ...
                                <div class="form-group mb-4">
                                    ...
                                    <textarea name="hazards_identified" id="hazards_identified" class="form-control" rows="3" required
                                        placeholder="Describe hazards identified"></textarea>
                                ...
                                <div class="form-group mb-4">
                                    ...
                                    <textarea name="affected_persons" id="affected_persons" class="form-control" rows="3" required
                                        placeholder="Describe who might be affected"></textarea>
                                ...
                                <div class="form-group mb-4">
                                    ...
                                    <textarea name="current_measures" id="current_measures" class="form-control" rows="3" required
                                        placeholder="Describe current risk control measures"></textarea>
                                ...
                                <div class="form-group mb-4">
                                    ...
                                    <textarea name="further_measures" id="further_measures" class="form-control" rows="3" required
                                        placeholder="Describe further risk control measures"></textarea>
                                ...
                                <div class="form-group mb-4">
                                    <label for="days_needed">Number of days action is needed to be done by to apply new
                                        risk
                                        control measures <span class="text-danger">*</span></label>
                                    <input type="number" name="days_needed" id="days_needed" class="form-control"
                                        required placeholder="Enter number of days needed">
                                    @error('days_needed')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                ...
                                <div class="form-group mb-4">
                                    ...
                                    <input type="number" name="reminder_days" id="reminder_days" class="form-control"
                                        required placeholder="Enter number of days for reminder">
                                    @error('reminder_days')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
    ...
    <script>
        ...
        $('#template').on('change', function() {
            ...
            $.ajax({
                url: '/company/risk_assessment/template',
                type: 'GET',
                data: {
