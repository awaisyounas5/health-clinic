    ...
    <div class="content">
        <div class="page-header">
            <div class="row">
                <div class="col-sm-12">
                    <ul class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{route('company.risk_assessment')}}">Risk Assessment</a></li>
                                                ...
                                                <tr id="row{{$risk_assessment->id}}">
                                                    ...
                                                    <td><a href="#" class="dropdown-toggle nav-link user-link" data-bs-toggle="dropdown">
                                                        ...
                                                        <div class="dropdown-menu">
                                                            <a class="dropdown-item" href="{{route('company.risk_assessment.edit',$risk_assessment->id)}}">Edit</a>
                                                            <a class="dropdown-item" onclick="deleteRiskAssessment({{$risk_assessment->id}})">Delete</a>
                                                            <a class="dropdown-item" href="{{route('company.risk_assessment.view_assessment',$risk_assessment->id)}}">View</a>
                                                        </div>
                                                    </td>
                                                </tr>
                                                @endforeach
    ...
    function deleteRiskAssessment(id) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                $.ajax({
                    type: 'DELETE',
                    url: '/company/risk_assessment/delete/' + id,
                    data: {
