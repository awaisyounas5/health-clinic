    ...
    <div class="content">
        <div class="page-header">
            <div class="row">
                <div class="col-sm-12">
                    <ul class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{route('company.risk_assessment')}}">Risk Assessments</a></li>
                                        ...
                                        <table class="datatable table table-stripped dataTable no-footer" id="DataTables_Table_0" role="grid" aria-describedby="DataTables_Table_0_info">
                                            ...
                                            <tbody>
                                                ...
                                                <tr role="row" class="odd">
                                                    ...
                                                    <td>
                                                        <a href="{{ route('company.risk_assessment.view',$risk_assessment->patient_id)}}" class="btn btn-primary btn-sm">View</a>
                                                        </td>
                                                    </tr>
                                                    @endforeach
                                                    @endif
