    ...
    <div class="content">
        <div class="page-header">
            <div class="row">
                <div class="col-sm-12">
                    <ul class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{route('company.template')}}">Risk Assessments Template</a></li>
            ...
            <div class="col-sm-12">
                <div class="card-box">
                    <div class="card-block">
                        ...
                        <form action="{{route('company.risk_assessment.template_store')}}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
