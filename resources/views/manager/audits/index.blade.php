    ...
    <div class="content">
        <div class="page-header">
            <div class="row">
                <div class="col-sm-12">
                    <ul class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{route('manager.audit')}}">Audits</a></li>
                                            ...
                                            <tbody>
                                                ...
                                                <tr role="row" class="odd" id="row{{$audit->id}}">
                                                    ...
                                                    <div class="dropdown-menu">
                                                        <a class="dropdown-item" href="{{route('manager.audit.edit',$audit->id)}}">Edit</a>
