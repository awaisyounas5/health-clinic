    ...
    <div class="content">
        <div class="page-header">
            <div class="row">
                <div class="col-sm-12">
                    <ul class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{ route('manager.routines') }}">Routine Activities </a></li>
                                    ...
                                    <tr id="row{{$routine->id}}">
                                        ...
                                        <td><a href="#" class="dropdown-toggle nav-link user-link" data-bs-toggle="dropdown">
                                            ...
                                            <div class="dropdown-menu">
                                                <a class="dropdown-item" href="{{ route('manager.routines.edit', $routine->id) }}">Edit</a>
    ...
    function deleteRoutine($id) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                $.ajax({
                    type: 'DELETE',
                    url: '/manager/routines/delete/' + $id,
                    data: {
