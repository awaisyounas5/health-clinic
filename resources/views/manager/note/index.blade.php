    ...
    <div class="content">
        <div class="page-header">
            <div class="row">
                <div class="col-sm-12">
                    <ul class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{route('manager.shift_note')}}">Notes</a></li>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <div class="dropdown-menu">
                                                        <a class="dropdown-item" href="{{route('manager.shift_note.view',$shift_note->patient_id)}}">View Entire Shift Notes</a>
                                                    </div>
                                                </td>
                                                </tr>
                                                @endforeach
