    ...
    <div class="content">
        <div class="page-header">
            <div class="row">
                <div class="col-sm-12">
                    <ul class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{route('manager.template')}}">Templates</a></li>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="#" class="dropdown-toggle nav-link user-link" data-bs-toggle="dropdown">
                                                        ...
                                                        <div class="dropdown-menu">
                                                            <a class="dropdown-item" href="{{route('manager.risk_assessment.template_edit',$template->id)}}">Edit</a>
    ...
    function deleteTemplate(id) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                $.ajax({
                    type: 'DELETE',
                    url: '/manager/template/delete/' + id,
                    data: {
