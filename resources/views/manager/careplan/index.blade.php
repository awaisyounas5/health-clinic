    ...
    <div class="content">
        <div class="page-header">
            <div class="row">
                <div class="col-sm-12">
                    <ul class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{route('manager.careplan')}}">Care Plans </a></li>
                                            ...
                                            <tbody>
                                                ...
                                                <tr >
                                                    ...
                                                    <div class="dropdown-menu">
                                                        <a class="dropdown-item" href="{{route('manager.careplan.view',$patientId)}}">View Entire Care Plan</a>
                                                    </div>
                                                </td>
                                                </tr>
                                                @endforeach
