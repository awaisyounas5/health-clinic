    ...
    <div class="content">
        <div class="page-header">
            <div class="row">
                <div class="col-sm-12">
                    <ul class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{route('manager.competency.failed')}}">Audits</a></li>
                        <li class="breadcrumb-item"><i class="feather-chevron-right"></i></li>
                        <li class="breadcrumb-item active">View Failed Audits</li>
                    </ul>
                </div>
            </div>
        </div>
            ...
            <div class="col-sm-12">
                <div class="card-box">
                    <div class="card-block">
                        <h6 class="card-title text-bold">Failed Audits</h6>
...
<script>
        ...
        $(document).ready(function() {
            $.ajax({
                    type: 'GET',
                    url: '/manager/competency/passed/get_failed_data',
                    data: {
