            ...
            <div class="page-header">
                <div class="row">
                    <div class="col-sm-8 col-4">
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{ route('manager.roaster') }}">Roaster </a></li>
        ...
        <script>
            $(document).ready(function() {
                                ...
                                Swal.fire({
                                    ...
                                    if (result.isConfirmed) {
                                        window.location.href =
                                            '/manager/shift_note/view_details/' + info.event
                ...
                $("#publish-roaster").on('click', function() {
                    ...
                    $.ajax({
                        url: '/manager/roaster/publish_events/' + $team_id,
                        type: 'POST',
                        data: {
                            _token: @json(csrf_token()),
                        },
                ...
                $("#create_event").on('submit', function(e) {
                    ...
                    $.ajax({
                        url: '/manager/roaster/event_store',
                        type: 'POST',
                        data: $(this).serialize(),
                        success: function(data) {
                            $("#staff_member").val('');
                ...
                $("#edit_event").on('submit', function(e) {
                    ...
                    $.ajax({
                        url: '/manager/roaster/event_edit/' + id,
                        type: 'POST',
                        data: $(this).serialize(),
                        success: function(data) {
