...
class AuditController extends Controller
{
    ...
    public function index(){
        $audits=Audit::where('created_by',Auth::user()->id)->get();
        return view('company.audits.index',compact('audits'));
    }
    public function create(){
        return view('company.audits.create');
    }
    ...
    public function edit($id){
        $audit=Audit::with('audit_standard')->where('id',$id)->where('created_by',Auth::user()->id)->first();
        return view('company.audits.edit',compact('audit'));
    }
    ...
    {
        try {
            $audit = Audit::where('id', $id)->where('created_by', Auth::user()->id)->first();
            if ($audit) {
                $audit->delete();
            }
