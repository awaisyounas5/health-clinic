...
class RiskAssessmentController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('company.risk_assessments.index', compact('risk_assessments'));
    }
    ...
    public function create()
    {
        ...
        $templates = Template::where('created_by', Auth::id())->get();
        return view('company.risk_assessments.create', compact('patients', 'staff_members', 'templates'));
    }
    ...
    public function view($id)
    {
        ...
        return view('company.risk_assessments.view_by_patient', compact('risk_assessments'));
    }
    public function view_assessment($id)
    {
        $report = RiskAssessment::where('id', $id)->where('created_by', Auth::id())->first();
        return view('company.risk_assessments.view', compact('report'));
    }

    public function edit($id)
    {
        $risk_assessment = RiskAssessment::where('id', $id)->where('created_by', Auth::user()->id)->first();
        $patients = User::role('patient')->get();
        $staff_members = User::role('staff_member')->get();
        return view('company.risk_assessments.edit', compact('risk_assessment', 'patients', 'staff_members'));
    }
    ...
    public function update($id, RiskAssessmentRequest $request)
    {
        ...
        try {
            DB::beginTransaction();
            RiskAssessment::where('id', $id)->where('created_by', Auth::user()->id)->update([
                'title' => $request->name,
                'risk_level' => $request->risk_level,
                'patient_id' => $request->patient_id,
                'activity_issue' => $request->activity_issue,
    ...
    {
        return view('company.risk_assessments.template_create');
    }
    ...
    {
        $templates = Template::where('created_by', Auth::id())->get();
        return view('company.risk_assessments.template', compact('templates'));
    }

    public function template(Request $request)
    {
        try {
            $template = Template::where('title', $request->template)->where('created_by', Auth::id())->first();
    ...
    {
        $template = Template::where('id', $id)->where('created_by', Auth::user()->id)->first();
        return view('company.risk_assessments.template_edit', compact('template'));
    }

    public function template_update(Request $request,$id){
        try {
            DB::beginTransaction();
            Template::where('id', $id)->where('created_by', Auth::user()->id)->update([
                'title' => $request->template_name,
                'risk_level' => $request->risk_level,
                'activity_issue' => $request->activity_issue,
                'hazards_identified' => $request->hazards_identified,
