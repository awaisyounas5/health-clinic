...
class CompetencyController extends Controller
{
    ...
    {
        return view('company.competencies.passed');
    }
    ...
    public function get_passed_data()
    {
        ...
        $audits = Audit::where('created_by', Auth::user()->id)
    ...
    public function competency_improvement(){
        ...
        return view('company.competencies.room_for_improvement');
    }
    ...
    public function competency_failed(){
        return view('company.competencies.failed');
    }
