...
class ShiftTypeController extends Controller
{
    ...
    {
        $shift_types = ShiftType::where('created_by', Auth::id())->get();
        return view('company.shift_types.index', compact('shift_types'));
    }

    public function create()
    {
        $teams = Team::where('created_by', Auth::id())->get();
        return view('company.shift_types.create', compact('teams'));
    }
    ...
    public function edit($id)
    {
        ...
        $teams = Team::where('created_by', Auth::id())->get();
        return view('company.shift_types.edit', compact('shift_type','teams'));
    }
