...
class ObservationController extends Controller
{
    ...
    {
        $observations = Observeration::where('created_by', Auth::id())
            ->get()
            ->groupBy('patient_id');

        return view('company.observations.index', compact('observations'));
    }

    public function create()
    {
        $patients = User::role('patient')->where('created_by', Auth::id())->get();
        return view('company.observations.create', compact('patients'));
    }
    ...
    public function view($patientId)
    {
        ...
        return view('company.observations.view_by_patient', compact('observations'));
    }
    ...
    public function store(ObservationRequest $request)
    {
        ...
        try {
            ...
            return redirect()->route('company.observation')->with('success', 'Observation activity has been created successfully');
        } catch (\Exception $e) {
    ...
    public function edit($id)
    {
        ...
        $patients = User::role('patient')->where('created_by', Auth::id())->get();
        return view('company.observations.edit', compact('observation','patients'));
    }
    ...
    public function update(ObservationRequest $request, $id)
    {
        ...
        try {
            ...
            DB::commit();
            return redirect()->route('company.observation')->with('success', 'Observation activity has been updated successfully');
        } catch (\Exception $e) {
            DB::rollback();
            return redirect()->back()->withInput()->with(['error' => $e->getMessage()]);
        }
