...
class StaffController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('company.staffs.index', compact('staffs'));
    }

    public function create()
    {
        $teams = Team::where('created_by', Auth::id())->get();
        return view('company.staffs.create',compact('teams'));
    }
    ...
    {
        $staff = User::role('staff_member')->where('id',$id)->where('created_by',Auth::user()->id)->first();
        return view('company.staffs.view', compact('staff'));
    }
    public function edit($id)
    {
        $staff = User::role('staff_member')->where('id',$id)->where('created_by',Auth::user()->id)->first();
        $teams = Team::where('created_by', Auth::id())->get();
        return view('company.staffs.edit', compact('staff','teams'));
    }
