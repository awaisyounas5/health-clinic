...
class PatientController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('company.patients.index', compact('patients'));
    }

    public function create()
    {
        return view('company.patients.create');
    }
    ...
    {
        $patient = User::role('patient')->where('id',$id)->where('created_by',Auth::user()->id)->first();
        return view('company.patients.view', compact('patient'));
    }
    public function edit($id)
    {
        $patient = User::role('patient')->where('id',$id)->where('created_by',Auth::user()->id)->first();
        return view('company.patients.edit', compact('patient'));
    }
