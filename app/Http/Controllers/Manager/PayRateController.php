...
class PayRateController extends Controller
{
    ...
    {
        $pay_rates = PayRate::where('created_by', Auth::user()->created_by)->get();
        return view('manager.pay_rates.index', compact('pay_rates'));
    }
    ...
    public function create()
    {
        ...
        return view('manager.pay_rates.create', compact('teams', 'staffs'));
    }
    ...
    public function edit($id)
    {
        ...
        $teams = Team::where('created_by', Auth::user()->created_by)->get();
        $staffs = User::role('staff_member')->where('created_by', Auth::user()->created_by)->get();
        return view('manager.pay_rates.edit', compact('pay_rate', 'teams', 'staffs'));
    }
